...
import PublicCertificateVerification from "../pages/verification/PublicCertificateVerification.jsx";
import UserScanner from "../pages/verification/UserScanner.jsx"; 
import PublicLanding from "../pages/verification/PublicLanding.jsx";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path={paths.verify} element={<PublicLanding />} />
        <Route path={paths.verificationDetail} element={<PublicCertificateVerification />} />
        <Route path={paths.scanner} element={<UserScanner />} />
        ...
        <Route path={paths.home} element={<PublicLanding />} />
        <Route
          path="*"
          element={
