...
import { ArrowLeft, CheckCircle2, Copy, Download, Printer, ShieldCheck } from "lucide-react";
...
export default function CertificateDetails(){
 ...
 useEffect(()=>{QRCode.toDataURL(verifyUrl,{width:150,margin:1,errorCorrectionLevel:"M"}).then(setQrDataUrl).catch(()=>setQrDataUrl(""));},[verifyUrl]);
